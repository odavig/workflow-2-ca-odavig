...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"js/programs.js":[function(require,module,exports) {
...
function handleNewsJson(json) {
  ...
  var newsUrl = "https://api.nasa.gov/techport/api/projects/".concat(results[0].id, "?api_key=s1t0dgdnK3sCldGLGkOSNrGW7Oe7hbLd7VwTs44M");
  ...
  function handleNewsJsonAgain(json) {
    ...
    var newsHTML = "\n  <h2 class=\"sectionSubHeading\">".concat(results.title, "</h2>\n  <ul>\n    <li><i>Start date: </i>").concat(results.startDate, "</li>\n    <li><i>End date: </i>").concat(results.endDate, "</li>\n  </ul>\n  <p class=\"sectionParagraph\"> <i>Description: </i>").concat(results.description, " <i>Benefits: </i>").concat(results.benefits, " Read more about this mission <a href=\"").concat(results.website, "\">here.</a>\n  Or check out every mission at <a href=\"https://www.nasa.gov/missions/\">NASA.</a></p>\n  ");
...
},{}]},{},["../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","js/programs.js"], null)
//# sourceMappingURL=/programs.95c7a36f.js.map